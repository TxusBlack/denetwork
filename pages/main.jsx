...
const Main = () => {
          ...
          <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
              <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                >
                  <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZXCTiibgMYoAeB6Cxq9OgU-tMo_RVdXQBVQ&usqp=CAU"
                    alt="Profile"
                    srcset="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZXCTiibgMYoAeB6Cxq9OgU-tMo_RVdXQBVQ&usqp=CAU"
                    className="img-fluid"
                    style={{ width: "50px" }}
                  />
                </a>
  ...
  return (
    <div>
      <Layout>
        <div>We're building the site</div>
      </Layout>
    </div>
  );
};
